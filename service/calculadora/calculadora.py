...
class Client(Iface):
    ...
    def recv_division(self):
        ...
        if result.operacionInvalida is not None:
            raise result.operacionInvalida
    ...
    def resta(self, minuendo, sustraendo):
        ...
        """
        self.send_resta(minuendo, sustraendo)
        return self.recv_resta()

    def send_resta(self, minuendo, sustraendo):
...
class Processor(Iface, TProcessor):
    ...
    def process_division(self, seqid, iprot, oprot):
        ...
        try:
            ...
            raise
        except OperacionIvalida as operacionInvalida:
            msg_type = TMessageType.REPLY
    ...
    def process_resta(self, seqid, iprot, oprot):
        ...
        result = resta_result()
        try:
            result.success = self._handler.resta(args.minuendo, args.sustraendo)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except OperacionIvalida as operacionInvalida:
...
class division_result(object):
    ...
    def __init__(self, success=None, operacionInvalida=None,):
        self.success = success
        self.operacionInvalida = operacionInvalida
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.operacionInvalida = OperacionIvalida.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            oprot.writeFieldEnd()
        if self.operacionInvalida is not None:
            oprot.writeFieldBegin('operacionInvalida', TType.STRUCT, 1)
            self.operacionInvalida.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
division_result.thrift_spec = (
    ...
    (1, TType.STRUCT, 'operacionInvalida', [OperacionIvalida, None], None, ),  # 1
)
